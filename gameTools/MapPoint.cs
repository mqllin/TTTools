...
namespace TTTools
{
    class MapPoint
    {
        ...
        private static Dictionary<string, (Point offset, Point mapPx, Point localPx)> mapConfigs = new Dictionary<string, (Point offset, Point mapPx, Point localPx)>
        {
            {"应天府", (new Point(0, 0), new Point(485, 354), new Point(399, 294))},
            {"应天府东", (new Point(-392, 24), new Point(80, 62), new Point(9, 345))},
            // 其他地图，格式：{"地图名", (左上角偏移, 地图像素尺寸, 坐标尺寸)}
        };
